                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="w-box blog-post">
                                <div class="figure">
                                    <h2> <?= $activity['name_'.$fieldLanguage] ?> </h2>
                                    <ul class="meta-list">
                                        <li> <a href="#"><?= $activity['created']->i18nFormat('dd-MM-YYYY') ?></a> </li>
                                    </ul>
                                    <?= $this->element('frontend/facebook_like') ?>
                                    <div class="content">
                                        <?= $activity['content_'.$fieldLanguage] ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 comments-wr">
                            ...
                            foreach($others as $item):
                                ...
                                ?>
                                <div class="comment">
                                    <?= $this->Core->image('activities/'.$item['image'], 400, 300) ?>
                                    <p>
