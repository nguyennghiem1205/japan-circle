...
class AppController extends Controller
{
    ...
    public $imageFields = [];
    public $jcApi;
    public $fieldLanguage = null;
    public $titleLayout = null;
    public $allowAccess = null;
    ...
    function handleAjaxFormRequest()
    {
        ...
        if($this->request->is('ajax') && isset($this->request->data['ajax_form']))
        {
            ...
            $entity = $this->Core->patchEntity($entity, $this->request->data,$model);
            ...
            {
                echo 'Hey developer: status must be "success" or "error"'; 
                echo json_encode($this->ajax);die();
            }
        }
        /* ---------- Handle Ajax Output } ---------- */
    ...
    function checkAuth()
    {
        ...
        $this->allowAccess = true; // Default allow access all actions
