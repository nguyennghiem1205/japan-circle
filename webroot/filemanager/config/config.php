...
if (!defined('USE_ACCESS_KEYS'))define('USE_ACCESS_KEYS', false);
...
$upload_dir = 'upload/file_manager/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../upload/file_manager/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = '../upload/file_manager_thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)

/* ---------- Duy NB : Split directory for each user login { ---------- */
