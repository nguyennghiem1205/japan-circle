...
class LanguagesController extends AppController
{
    ...
    public function update_new_key()
    {
        ...
        $dir = new Folder('../');
        $fileList = $this->_directoryToArray($dir->path);
        $allKey = array();
    ...
    public function server_delete($id = null)
    {
        ...
        if($this->request->is(['post', 'put', 'patch'])) {
            if ($dbServer->delete('languages', ['id' => $id])) {
                ...
                $this->Flash->success(__('The key could not be deleted. Please, try again.'));
            }
        }
    }
    ...
    public function export()
    {
        if($this->request->is('post')) {
            ...
            if ($File = new File($path, true, 0777)) {
                ...
                $this->Flash->success(__('MsgLanguageExported', true));
            } else {
                $this->Flash->error(__('MsgLanguageErrorExported', true));
            }
