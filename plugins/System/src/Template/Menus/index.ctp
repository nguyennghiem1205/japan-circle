                        ...
                        <?php if(isset($menu->Child)):?>
                            ...
                            <tr class="sort-disabled">
                                ...
                                <td style="text-align: center">
                                    <?php
                                    if($child->display)
                                        echo $this->Html->link($this->Html->image("System.active.png",array('width' => 12, 'height' => 12)),array('action' => 'set_active',$child->id,0),array('escape'=>false));
                                    else
                                        echo $this->Html->link($this->Html->image("System.lock.png",array('width' => 12, 'height' => 12)),array('action' => 'set_active',$child->id,1),array('escape'=>false));
                                    ?>
                                </td>
