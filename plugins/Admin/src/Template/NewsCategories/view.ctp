                    ...
                    <fieldset>
                        <table id="user" class="table table-bordered table-striped" style="clear: both">
                            <tbody>
                                ...
                                <td style="width:65%"><?= h($newsCategory->id) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Name'). (' (VIE)') ?></td>
                                <td style="width:65%"><?= h($newsCategory->name_vie) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Name'). (' (ENG)') ?></td>
                                <td style="width:65%"><?= h($newsCategory->name_eng) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Name'). (' (JPN)') ?></td>
                                <td style="width:65%"><?= h($newsCategory->name_jpn) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Created') ?></td>
                                <td style="width:65%"><?= h($newsCategory->created) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Modified') ?></td>
                                <td style="width:65%"><?= h($newsCategory->modified) ?></td>
                            </tr>
                                                    </tbody>
                        </table>
                    </fieldset>
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?= $this->Html->link(__('Edit'), ['action' => 'edit', $newsCategory->id], ['class' => 'btn btn-primary']) ?>
                            </div>
                        </div>
                    </div>
                </div>
