                    ...
                    <fieldset>
                        <table id="user" class="table table-bordered table-striped" style="clear: both">
                            <tbody>
                                ...
                                <td style="width:65%"><?= h($activityCategory->id) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Name').' (VIE)' ?></td>
                                <td style="width:65%"><?= h($activityCategory->name_vie) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Name').' (ENG)' ?></td>
                                <td style="width:65%"><?= h($activityCategory->name_eng) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Name').' (JPN)' ?></td>
                                <td style="width:65%"><?= h($activityCategory->name_jpn) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Status') ?></td>
                                <td style="width:65%"><?= ($activityCategory->status)? __('Yes'): __('No') ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Created') ?></td>
                                <td style="width:65%"><?= h($activityCategory->created) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Modified') ?></td>
                                <td style="width:65%"><?= h($activityCategory->modified) ?></td>
                            </tr>
                                                    </tbody>
                        </table>
                    </fieldset>
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?= $this->Html->link(__('Edit'), ['action' => 'edit', $activityCategory->id], ['class' => 'btn btn-primary']) ?>
                            </div>
                        </div>
                    </div>
                </div>
