                    ...
                    <fieldset>
                        <section>
                            <label class="input state-disabled">
                                <?= $this->Form->input('email', ['disabled' => true, 'required' => false, 'placeholder' => __('Email address')]); ?>
                    ...
                    <fieldset>
                        <div class="row">
                            ...
                            <section class="col col-12">
                                ...
                                <label class="input">
                                    <?= $this->Form->input('avatar', ['label' => false, 'placeholder' => 'Avatar', 'type' => 'file', 'class' => 'hw-file']); ?>
                                </label>
                            </section>
                        </div>
                    </fieldset>
