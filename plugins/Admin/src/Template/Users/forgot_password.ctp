        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-md-offset-3 col-lg-offset-3">
                <div class="well no-padding">
                    <?= $this->Form->create(null, ['url' => '#', 'class' => 'login-form', 'class' => 'smart-form client-form'])?>
                        <header>
                            <?= __('Sign In')?>
                        </header>
                        ...
                        <fieldset>
                            ...
                            <section>
                                ...
                                <label class="input"><i class="icon-append fa fa-user"></i>
                                    ...
                                    <b class="tooltip tooltip-top-right"><i class="fa fa-user txt-color-teal"></i> <?= __('Please enter email address/username')?></b></label>
                            </section>

                            <section>
                                <label class="label"><?= __('you')?></label>
                                <label class="input"> <i class="icon-append fa fa-lock"></i>
                                    <input type="password" name="password">
                                    <b class="tooltip tooltip-top-right"><i class="fa fa-lock txt-color-teal"></i> <?= __('Enter your password')?></b> </label>
                                <div class="note">
                                    <a href="forgotpassword.html"><?= __('Forgot password?')?></a>
                                </div>
                            </section>
