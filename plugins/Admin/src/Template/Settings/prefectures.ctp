<?php $this->Html->addCrumb(__('District')); ?>
<div class="row">
                ...
                <div class="widget-body no-padding">
                    ...
                    <thead>
                        <tr>
                                            ...
                                            <th class="hasinput"><input type="text" class="form-control" placeholder="<?= __('District Name')?>" /></th>
                        </tr>
                        <tr>
                                            <th><?= __('Code') ?></th>
