                ...
                <div class="widget-body no-padding">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            <section class="col col-md-6">
                                <span><?= __('Status')?></span>
                                <?= $this->Form->input('status', ['required' => false,'empty' => '---'.__('Select Status').'---','options' => \Cake\Core\Configure::read('Inquiry.status'),'placeholder' => __('status')]) ?>
                            </section>
