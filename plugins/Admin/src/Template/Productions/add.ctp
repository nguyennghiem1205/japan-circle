        ...
        <div class="jarviswidget jarviswidget-sortable jarviswidget-color-darken" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false" role="widget" style="">
            ...
            <div role="content">
                ...
                <div class="widget-body no-padding">
                    ...
                    <header><?= __('Add Production') ?></header>
                    <fieldset>
                        <section>
                            <?= $this->Form->input('member_id', ['type' => 'text','placeholder' => __('member_id'), 'options' => $members]) ?>
                        </section>
                        <section>
                            <?= $this->Form->input('industry_code', ['options' => $industries,'placeholder' => __('industry_code')]) ?>
                        </section>
                        <section>
                        ...
                        <section>
                            <?= $this->Form->input('short_description', ['placeholder' => __('short_description')]) ?>
                        </section>
                        <section>
                        ...
                        <section>
                            <?= $this->Form->input('description', ['placeholder' => __('description')]) ?>
                        </section>
                        <section>
                            <?= $this->Form->input('status', ['options'=>\Cake\Core\Configure::read('Production.status'),'placeholder' => __('status')]) ?>
                        </section>
                    </fieldset>
