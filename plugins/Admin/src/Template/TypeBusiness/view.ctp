                    ...
                    <fieldset>
                        <table id="user" class="table table-bordered table-striped" style="clear: both">
                            <tbody>
                                ...
                                <td style="width:65%"><?= h($typeBusines->id) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Type Name Vie') ?></td>
                                <td style="width:65%"><?= h($typeBusines->type_name_vie) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Type Name Eng') ?></td>
                                <td style="width:65%"><?= h($typeBusines->type_name_eng) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Type Name Jpn') ?></td>
                                <td style="width:65%"><?= h($typeBusines->type_name_jpn) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Order') ?></td>
                                <td style="width:65%"><?= h($typeBusines->order) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Created') ?></td>
                                <td style="width:65%"><?= h($typeBusines->created) ?></td>
                            </tr>
                                                    <tr>
                                <td style="width:35%;"><?= __('Modified') ?></td>
                                <td style="width:65%"><?= h($typeBusines->modified) ?></td>
                            </tr>
                                                    </tbody>
                        </table>
                    </fieldset>
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?= $this->Html->link(__('Edit'), ['action' => 'edit', $typeBusines->id], ['class' => 'btn btn-primary']) ?>
                            </div>
                        </div>
                    </div>
                </div>
