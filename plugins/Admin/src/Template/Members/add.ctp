                        ...
                        <fieldset id="com_vie" class="tab-pane active">
                            <div class="row select-ajax">
                                <section class="col col-md-6">
                                    ...
                                    <?= $this->Form->input('category_industry', ['data-url' => '/members/listIndustries','data-child'=>'industry-child','class' => 'select-parent','empty' => '---'.__('Select Category Industry').'---','options' => $industry_parents,'placeholder' => __('Category Industry')]) ?>
                                </section>
                                <section class="col col-md-6">
                                    <span><?= __('Industry')?></span> <span class="required">(*)</span>
                                    <?= $this->Form->input('industry_code', ['options'=>array(),'type' => 'select','class' => 'industry-child','empty' => '---'.__('Select Industry').'---','placeholder' => __('Industry')]) ?>
                                </section>
                            </div>
                            <div class="row">
                                <section class="col col-md-6">
                            ...
                            <div class="row">
                                <section class="col col-md-6">
                                    ...
                                    <?= $this->Form->input('city_code', ['data-url' => '/members/getListPrefecture','data-child'=>'ajax-prefecture','class' => 'select-parent','empty' => '---'.__('Select City').'---','options' => $list_cities,'placeholder' => __('City')]) ?>
                                </section>
                                <section class="col col-md-6">
                                    <span><?= __('Prefecture') ?></span>
                                    <?= $this->Form->input('prefecture_code', ['required' => false,'empty' => '---'.__('Select Prefecture').'---','type' => 'select','class' => 'ajax-prefecture','placeholder' => __('District')]) ?>
                                </section>
                            </div>
                            <div class="row">
                                <section class="col col-md-6">
