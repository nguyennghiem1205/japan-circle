...
<div class="pull-right">
    ...
    <div id="logout" class="btn-header transparent pull-right">
        <span>
            <a href="<?php echo $this->Url->build(['plugin' => 'admin', 'controller'=>'users', 'action'=>'logout'])?>" title="<?php echo __('Sign Out')?>" data-action="userLogout" data-logout-msg="<?php echo __('You can improve your security further after logging out by closing this opened browser');?>">
    ...
    <ul class="header-dropdown-list hidden-xs">
        <li>
            ...
            ?>
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="<?= $this->Url->build('/img/blank.gif', true) ?>" class="flag <?= $defaultLang[$lang]['flag']?>" alt="<?= $defaultLang[$lang]['name']?>"> <span> <?= $defaultLang[$lang]['name']?> </span> <i class="fa fa-angle-down"></i> </a>
            <ul class="dropdown-menu pull-right">
                <?php
                ...
                ?>
                    <li>
                        <a href="<?= $this->Url->build(['plugin' => null, 'controller' => 'pages', 'action' => 'change_language', $value['key']])?>"><img src="<?= $this->Url->build('/img/blank.gif', true) ?>" class="flag <?= $value['flag']?>" alt="<?= $value['name']?>"> <?= $value['name']?> </a>
                    </li>
                <?php endforeach; ?>
            </ul>
        </li>
