        ...
        <div class="jarviswidget jarviswidget-sortable jarviswidget-color-darken" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false" role="widget" style="">
            ...
            <div role="content">
                ...
                <div class="widget-body no-padding">
                    ...
                    <header><?= __('Add Supporter') ?></header>
                    <fieldset>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <section class="col col-md-6">
                                ...
                                <?= $this->Form->input('identity_card', ['placeholder' => __('Identification No./Passport No.')]) ?>
                            </section>
                        </div>
                        ...
                        <div class="row">
                            <section class="col col-md-6">
                                ...
                                <?= $this->Form->input('city_code', ['required' => false,'multiple'=>true,'class' => 'chosen-select','data-placeholder' => '---'.__('Select City').'---','options' => $list_cities]) ?>
                                <section>
                        </div>
                        ...
                        <div class="row">
                            <section class="col col-md-6">
                                ...
                                <?= $this->Form->input('experience', ['placeholder' => __('experience')]) ?>
                            </section>
                            <section class="col col-md-6">
