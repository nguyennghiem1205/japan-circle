...
class UsersController extends AppController
{
    ...
    public function add($id = null)
    {
        ...
        {               
            $user = $this->Core->patchEntity($user, $this->request->data,'Users');
            ...
            {                                
                ...
                {
                $this->Flash->error(__('The user could not be saved. Please, try again.'), ['plugin' => 'Admin']);
            }
        }

        $this->imageFields = $user->imageFields;
        $this->buildHasMany($user,'menus',['container'=>'#hasmany-container','add'=>'.btn_add','delete'=>'.btn_delete']);
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Users->delete($user)) {
            ...
            $this->Flash->error(__('The user could not be deleted. Please, try again.'), ['plugin' => 'Admin']);
        }
        return $this->redirect(['action' => 'index']);
    }
        ...
        if($this->request->is(['patch', 'post', 'put'])){
            ...
            if($oldPass && $oldPassHash != $user->password) {
                ...
                if ($this->Users->save($user)) {
                    ...
                    $this->Flash->error(__('The user could not be changed. Please, try again.'), ['plugin' => 'Admin']);
                }
            }
        }
