...
class BannersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'position' => ['type' => 'integer', 'length' => 1, 'unsigned' => false, 'null' => false, 'default' => '1', 'comment' => '1. top, 2. bottom', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'position' => 1,
            'status' => 1,
            'created' => '2015-07-31 07:57:43',
            'modified' => '2015-07-31 07:57:43'
        ],
    ];
}
